 ...
 * Use the {@link AlimentoSuculentasFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class AlimentoSuculentasFragment extends Fragment {
    ...
    public AlimentoSuculentasFragment() {
     ...
     * @return A new instance of fragment AlimentoSuculentasFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static AlimentoSuculentasFragment newInstance(String param1, String param2) {
        AlimentoSuculentasFragment fragment = new AlimentoSuculentasFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=  inflater.inflate(R.layout.fragment_alimento_suculentas, container, false);

        textAlimento = view.findViewById(R.id.textAlimento);
        imgAlimento = view.findViewById(R.id.imgAlimento);
                    ...
                    for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                        if (count == 3) {
                            ...
                            if (suculentaModel != null) {
                                textAlimento.setText(suculentaModel.getInfo());
